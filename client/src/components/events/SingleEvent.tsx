...
import {Event, EventButton, EventButtonExpired, EventContent, EventDescription, EventItem, Image, IsExpired, EventTitle } 
            ...
            <Event>
                ...
                <EventContent>
                    ...
                    {systemDate > props.date ?
                        <div>
                            <IsExpired> {props.date} | {props.hour} </IsExpired>
